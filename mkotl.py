...
from enrichers.objecttypelibrary import enrich
from interfaces.schemas.objecttypelibrary import SchemaOTL
...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--mapping", help="""Mapping table (JSON) used to link to OTL""")
